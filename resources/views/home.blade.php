			...
			<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					<div class="item active">
						<img src="{{ asset('public/admin/uploads/images/thumbnail-articles/'.$articlesHot->first()->imgThumb) }}" alt="First slide">
						<!-- Static Header -->
						<div class="header-text hidden-xs title-slide">
							<div class="col-md-12 text-center">
								<h3>{{ $articlesHot->first()->title }}</h3>
							</div>
						</div><!-- /header-text -->
					</div>
					@for ($i = 1; $i < count($articlesHot); $i++)
					<div class="item">
						<img src="{{ asset('public/admin/uploads/images/thumbnail-articles/'.$articlesHot[$i]->imgThumb) }}" alt="Second slide">
						<!-- Static Header -->
						<div class="header-text hidden-xs title-slide">
							<div class="col-md-12 text-center">
								<h3>{{ $articlesHot[$i]->title }}</h3>
							</div>
						</div><!-- /header-text -->
					</div>
					@endfor
